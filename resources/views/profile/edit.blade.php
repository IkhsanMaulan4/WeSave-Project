        ...
        <div class="col-lg-9">
            ...
            <div class="card border-0 shadow-sm rounded-4 mb-4">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted small mb-4">Update your photo and personal details here.</p>
                    ...
                    <div class="d-flex align-items-center gap-4 mb-4 p-3 bg-light rounded-4 border border-light position-relative">
                        ...
                        <form action="{{ route('profile.update') }}" method="POST" enctype="multipart/form-data" class="flex-grow-1 d-flex align-items-center gap-3">
                            ...
                            <div class="flex-grow-1">
                                <label class="btn btn-white border shadow-sm fw-bold small mb-1 bg-white text-dark" for="avatarUpload" style="cursor: pointer;">
                                    <span class="material-symbols-outlined align-middle fs-6 me-1">upload</span> Change Photo
                                </label>
                                <input type="file" id="avatarUpload" name="avatar" class="d-none" accept="image/*" onchange="this.form.submit()"> <div class="small text-muted" style="font-size: 11px;">JPG, GIF or PNG. Max 10MB.</div>
                            </div>
                        </form>
                        ...
                        <form action="{{ route('profile.avatar.destroy') }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-outline-danger border-0 p-2 rounded-circle d-flex align-items-center justify-content-center" style="width: 38px; height: 38px;" onclick="return confirm('Hapus foto profil?')">
                                <span class="material-symbols-outlined fs-5">delete</span>
                            </button>
                        </form>
                        @endif
                    ...
                    <form action="{{ route('profile.update') }}" method="POST">
                        ...
                        <p class="text-muted small mb-4">Change your password.</p>
                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-4">
                                <label class="form-label small fw-bold text-muted">Confirm New</label>
            ...
            <form action="{{ route('profile.destroy') }}" method="POST">
                ...
                <div class="modal-body">
                    <p class="text-muted small">
                        Are you sure you want to delete your account? Once your account is deleted, all of your resources and data will be permanently deleted.
                    </p>
                    <div class="mb-3">
                        <label class="form-label small fw-bold text-muted">Please enter your password to confirm:</label>
                ...
                <div class="modal-footer border-0 pt-0">
                    <button type="button" class="btn btn-light rounded-3 fw-bold text-muted" data-bs-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-danger rounded-3 fw-bold px-4">Delete Account</button>
                </div>
            </form>
        </div>
    </div>
